...
public class MainController {
   ...
   public static void launchRegisterShowWindow(ActionEvent event) {
    ...
    /**
	  ...
	  */
	@FXML
  public static void launchMiniRoomChairSelectorWindow(ActionEvent event) {
		
		try {
			FXMLLoader loader = new FXMLLoader(Main.class.getResource("../ui/MiniRoomChairSelectorWindow.fxml"));
			loader.setController(new MiniRoomChairSelectorWindow());
			Parent parent = (Parent) loader.load();
